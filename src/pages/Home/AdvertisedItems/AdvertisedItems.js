...
import add1 from "../../../assets/advertised/advertised1.png";
import add2 from "../../../assets/advertised/advertised2.png";
import add3 from "../../../assets/advertised/advertised3.png";
import add4 from "../../../assets/advertised/advertised4.png";
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-4 justify-items-between mt-8 gap-y-8 lg:gap-y-0 gap-x-8">
                    <div className="flex items-start flex-col">
                        <div className="relative flex justify-center items-center bg-gray-100 py-12 px-16">
                            <img
                                className="hover:opacity-75 rounded-md"
                                src={add1}
                                alt="mobile"
                            />
                            <button className="absolute top-4 right-4 flex justify-center items-center p-3.5 bg-stone-800 hover:bg-orange-700 rounded-full ">
                                <svg
